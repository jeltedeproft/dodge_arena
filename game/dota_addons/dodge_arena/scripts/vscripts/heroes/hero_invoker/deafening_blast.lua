...
function deafening_blast_start( keys )
	...
	local dummy_speed = travel_speed / 30
...
function deafening_blast_hit( keys )
	...
	local exort_level = caster_owner:FindAbilityByName("invoker_exort"):GetLevel() - 1
	local quas_level = caster_owner:FindAbilityByName("invoker_quas"):GetLevel() - 1
